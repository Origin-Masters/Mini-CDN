...
public class CDNController {
    ...
    public static class RoutingIndex {
        ...
        private final Map<String, AtomicInteger> regionCounters = new ConcurrentHashMap<>();    //laufende index im Set für RR
        ...
        public void addEdge(String region, EdgeNode node) {
            if (region != null && node != null) {
                regionToNodes.computeIfAbsent(region, k -> new CopyOnWriteArraySet<>()).add(node);
