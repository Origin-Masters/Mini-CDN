package de.htwsaar.minicdn.cli.adapter.in.cli.shell;

import com.fasterxml.jackson.databind.JsonNode;
import de.htwsaar.minicdn.cli.application.admin.AdminEdgeService;
import de.htwsaar.minicdn.cli.application.context.CliContext;
import de.htwsaar.minicdn.cli.application.system.SystemShutdownService;
...
public final class MiniCdnInteractiveShell {
    ...
    /**
     * Stoppt beim Exit alle aktuell beim Router als managed geführten Edge-Instanzen.
     */
    private StopManagedEdgesResult stopAllManagedEdgesOnExit() {
        try {
            ...
            if (!managedEdges.isArray()) {
                return StopManagedEdgesResult.failed("Ungültige Antwort für managed Edges.");
            }
